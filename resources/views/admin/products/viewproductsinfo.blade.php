      ...
      <div class="row">
        <div class="col s12">
          <div class="section-title">
            <span class="theme-secondary-color">Product</span> Information
          </div>
        </div>
      </div>
                ...
                <div class="chart-box">
                  ...
                  <div class="cart-box-detail">
                    <ul>
                      ...
                      <li><label>Buy Price</label> : {{ $alp->buyingprice }}</li>
                      ...
                      <li><label>Category</label> : {{ $alp->catname }}</li>
                      <li><label>SubCategory</label> : {{ $alp->subcatname}}</li>
