...
<div id="page-content">
  <div class="wishlist-page">
    <div class="container">
      <div class="row">
        <div class="col s12">
          <div class="section-title">
            <span class="theme-secondary-color">Update Product</span> Information
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <form action="{{ route('updateproducts', ['id' => $alp->id]) }}" method="post" enctype="multipart/form-data" class="col s12">
          @csrf
          <div class="row">
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
              <input id="buyingprice" type="text" name="buyingprice" class="form-control @error('buyingprice') is-invalid @enderror" value="{{ $alp->buyingprice }}" required autocomplete="buyingprice" placeholder="Enter Your Product Buying Price" class="validate" required="buyingprice">
                @error('buyingprice')
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
              <input id="catname" type="text" name="catname" class="form-control @error('catname') is-invalid @enderror" value="{{ $alp->catname }}" required autocomplete="catname" placeholder="Enter Your Product Category Name" class="validate" required="catname" readonly="catname">
                @error('catname')
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
              <input id="subcatname" type="text" name="subcatname" class="form-control @error('subcatname') is-invalid @enderror" value="{{ $alp->subcatname }}" required autocomplete="subcatname" placeholder="Enter Your Product SubCategory Name" class="validate" required="subcatname" readonly="subcatname">
                @error('subcatname')
