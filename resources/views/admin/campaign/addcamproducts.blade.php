@extends('layouts.app')
@section('title', 'Add Campaign Products')
@section('content')
<div id="page-content">
  <div class="wishlist-page">
    <div class="container">
      <div class="row">
        <div class="col s12">
          <div class="section-title">
            <span class="theme-secondary-color">Add Campaign</span> Products
          </div>
        </div>
      </div>
      ...
      @endif
      <div class="row">
        <form action="/addcamproducts" method="post" enctype="multipart/form-data" class="col s12">
          @csrf
          <div class="row">
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
              <input id="campaignprice" type="text" name="campaignprice" class="form-control @error('campaignprice') is-invalid @enderror" required autocomplete="campaignprice" placeholder="Enter Your Product Campaign Price" class="validate" required="campaignprice">
                @error('campaignprice')
